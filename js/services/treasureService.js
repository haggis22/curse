		...
		function(diceService, Item, Armour, Weapon, Shield, Potion, BodyPart) {
			...
			this.treasures = 
			{
				'A' : [
                        ...
                        new Weapon({ name: 'club', damage: 2, skills: [ 'melee' ] }),
                        new Weapon({ name: 'short sword', damage: 3, skills: [ 'melee', 'sword' ] })
					  ],
				'B' : [
						// B is weapons and armour
                        new Weapon({ name: 'broadsword', damage: 4, skills: [ 'melee', 'sword' ] }),
                        new Weapon({ name: 'mace', damage: 3, skills: [ 'melee' ] }),
				...
				'C' : [
						// C is magic treasure!
                        new Weapon({ name: 'Excalibur', article: '', damage: 6, skills: [ 'melee', 'sword' ] }),
				...
				'D' : [
                        ...
                        new Weapon({ name: 'gilded sword', damage: 4, skills: [ 'melee', 'sword' ] })
					  ],
				'E' : [
