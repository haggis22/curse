	...
	app.service('monsterService', ['MonsterType', 'Sex', 'BodyShape', 'diceService', 'treasureService', 'AttackType', 'SkillType', 'Skill',
		function(MonsterType, Sex, BodyShape, diceService, treasureService, AttackType, SkillType, Skill) {
            ...
            this.monsters = [
                ...
                new MonsterType({ species: 'scorchfire dragon', bodyShape: BodyShape.prototype.WINGED_QUADRUPED, str: 18, int: 16, dex: 14, health: 22, frequency: 1, attacks: [ new AttackType({ type: BITE, damage: 5, weaponName: 'bites' }) ], treasure: ['A','D'], images: ['dragon.png']}),
                new MonsterType({ species: 'giant serpent', bodyShape: BodyShape.prototype.SNAKE, str: 10, int: 0, dex: 8, health: 12, frequency: 8, attacks: [ new AttackType({ type: BITE, damage: 2, weaponName: 'bites' }) ], images: ['serpent.png']}),
                ...
                new MonsterType({ species: 'chimera', bodyShape: BodyShape.prototype.WINGED_QUADRUPED, str: 15, int: 6, dex: 12, health: 18, frequency: 1, attacks: [ new AttackType({ type: CLAW, damage: 4, weaponName: 'claws' }) ], treasure: ['C','D'], images: ['chimera.png']}),
                ...
                new MonsterType({ species: 'harpy', bodyShape: BodyShape.prototype.WINGED_HUMANOID, str: 7, int: 8, dex: 14, health: 8, frequency: 4, sex: Sex.prototype.FEMALE, attacks: [ new AttackType({ type: CLAW, damage: 3, weaponName: 'claws' }) ], treasure: ['A','A'], images: ['harpy.png']}),
                new MonsterType({ species: 'griffin', bodyShape: BodyShape.prototype.WINGED_QUADRUPED, str: 15, int: 3, dex: 12, health: 15, frequency: 3, attacks: [ new AttackType({ type: CLAW, damage: 4, weaponName: 'claws' }) ], treasure: ['A','B','C'], images: []}),
                ...
                new MonsterType({ species: 'werewolf', str: 14, int: 7, dex: 14, health: 14, frequency: 6, attacks: [ new AttackType({ type: CLAW, damage: 4, weaponName: 'claws' }) ], treasure: ['A','B'], images: ['werewolf.png']}),
                new MonsterType({ species: 'manticore', bodyShape: BodyShape.prototype.WINGED_QUADRUPED, str: 15, int: 6, dex: 13, health: 15, frequency: 5, attacks: [ new AttackType({ type: BITE, damage: { min: 2, max: 4 }, weaponName: 'bites' }), new AttackType({ type: CLAW, damage: { min: 2, max: 3 }, weaponName: 'claws' }), new AttackType({ type: WEAPON, damage: { min: 2, max: 3 }, weaponName: 'spiked tail' }) ], treasure: ['A','B'], images: ['manticore.png']}),
                ...
                new MonsterType({ species: "Yuan-ti", str: { min: 10, max: 12 }, int: { min: 6, max: 8 }, dex: { min: 12, max: 15 }, health: { min: 14, max: 16 }, frequency: 5 , treasure: [ 'A', 'B' ] , images: ['yuan-ti1.jpg', 'yuan-ti2.jpg' ] }),
